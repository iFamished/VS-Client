...
for shellrc in "$HOME/.bashrc" "$HOME/.zshrc" "$HOME/.config/fish/config.fish"; do
  ...
  echo "alias install-modpack='bash $(pwd)/install-modpack.sh'" >> "$shellrc"
  echo "alias uninstall-mod='bash $(pwd)/uninstall-mod.sh'" >> "$shellrc"
  echo "alias list-mods='bash $(pwd)/list-mods.sh'" >> "$shellrc"
  echo "alias clean='bash $(pwd)/clean.sh'" >> "$shellrc"
  echo "alias help='bash $(pwd)/help.sh'" >> "$shellrc"
done
